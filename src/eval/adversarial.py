        ...
        "career_history": [
            {
                ...
                "end_date": None,
                "duration_months": 36,
                "description": ("Managed HR processes, conducted interviews, "
                                "organized team events. Used LLM tools for resume screening."),
                "is_current": True,
            },
            {
                ...
                "end_date": "2021-01",
                "duration_months": 31,
                "description": ("Coordinated recruitment across engineering teams. "
                                "Built pipelines. Used keyword matching for screening."),
                "is_current": False,
            },
        ],
        "education": [
