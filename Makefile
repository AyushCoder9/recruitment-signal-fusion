...
.PHONY: help eda precompute label train rank validate test charts deck clean

help:
	@echo "Targets: eda precompute label train rank validate test charts deck clean"
